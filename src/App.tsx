...
const App = () => {
  ...
  const tools = [
    ...
    { id: 3, cat: 'YouTube', name: '1-Click Script Writer', desc: 'Viral video ka poora structure likhega.', Icon: Youtube },
    { id: 4, cat: 'Graphics', name: '4K Image Upscaler', desc: 'Purani photo ko HD kar dega.', Icon: Palette },
    { id: 5, cat: 'Audio', name: 'Ultra-Human Voice', desc: 'AI voice jo bilkul insaan jaisi ho.', Icon: Mic },
    { id: 6, cat: 'Growth', name: '30-Day Content Plan', desc: 'Agle ek mahine ka content calendar.', Icon: TrendingUp },
  ];
      ...
      <header className="relative pt-32 pb-20 px-6 text-center">
        ...
        <div className="max-w-xl mx-auto mt-28 relative group px-4">
          ...
          <input 
            ...
            className="w-full bg-[#0c0c0c] border border-white/5 py-5 pl-16 pr-8 rounded-2xl text-lg text-white focus:outline-none focus:border-white/20 shadow-2xl transition-all"
